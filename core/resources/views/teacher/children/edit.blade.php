...
<div class="padding">
    <div class="box">
        ...
        <div class="box-body">
            <form class="form" action="{{ route('childrens.update',$children->id) }}" method="post"
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <input type="text" class="form-control" placeholder="{{ __('backend.childname-ar') }}"
                            name="name_ar" value="{{ old('name_ar',$children->name_ar) }}">
                        @error('name_ar')
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ __('backend.childname-en') }}"
                            name="name_en" value="{{ old('name_en',$children->name_en) }}">
                        @error('name_en')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{ __('backend.childname') }}" name="name"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" min="1" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                            class="form-control" placeholder="{{ __('backend.childage') }}" name="age"
                ...
                <div class="col-md-12">
                    <fieldset class="form-group">
                        ...
                        <textarea name="problem" class="form-control" id="editor1"
                            placeholder="{{ __('backend.childproblem') }}">
                ...
                <textarea name="problem_ar" class="form-control" id="editor1"
                    placeholder="{{ __('backend.childproblem-ar') }}">
        ...
        <div class="col-md-6">
            <fieldset class="form-group">
                ...
                <textarea name="problem_en" class="form-control" id="editor"
                    placeholder="{{ __('backend.childproblem-en') }}">
    ...
    <div class="row pt-4">
        <div class="col-12">
            ...
            <div class="file-loading">
                <input type="file" name="images[]" id="children-images" class="file-input-overview" multiple="multiple"
                    accept="image/*,.pdf">
        ...
        initialPreviewConfig: [
            ...
            @foreach($children - > media as $media) {
                ...
                caption: "{{ $media->file_name }}",
                    ...
                    width: "120px",
                    url:
                    "{{ route('childrens.remove_image', ['image_id' => $media->id, 'children_id' => $children->id, '_token' => csrf_token()]) }}",
                    key: {
                        {
                            $media - > id
                        }
