        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                    ...
                    <a href="{{ route('SChildrenConsultingReports',$children_id) }}">{{ __('cruds.Reports.Consulting') }}</a> /
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{route('SChildrenConsultingReports',$children_id)}}">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['SConsultingReportUpdate',$report->id],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        ...
                        <a href="{{route('SChildrenConsultingReports', $children_id)}}"
