        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                    ...
                    <a href="{{ route('showChildrenFinalReports',$children_id) }}">{{ __('cruds.Reports.FinalReport') }}</a> /
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{route('showChildrenFinalReports',$children_id)}}">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['updateFinalReport',$report->id],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                                ...
                                <div class="box p-a-xs">
                                    {!! Form::number('develop',$report->develop , array('placeholder' => '','class' => 'form-control','id'=>'develop','required'=>'')) !!}
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                                ...
                                <div class="box p-a-xs">
                                    {!! Form::text('recommends',$report->recommends , array('placeholder' => '','class' => 'form-control','id'=>'recommends','required'=>'')) !!}
                                </div>
                        </div>
                    </div> 
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        ...
                        <a href="{{route('showChildrenFinalReports', $children_id)}}"
