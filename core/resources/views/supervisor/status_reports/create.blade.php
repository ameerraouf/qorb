        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                    ...
                    <a href="{{ route('SChildrenStatusReports', $child_id) }}">{{ __('cruds.Reports.Status') }}</a> /
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{route('SChildrenStatusReports',$child_id)}}">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['SStatusReportStore',$child_id],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        ...
                        <a href="{{route('SChildrenStatusReports', $child_id)}}"
