           ...
           {{-- @if(count($Topic->maps) >0)
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        {!! Form::textarea('contact_message','', array('placeholder' => __('frontend.message'),'class' => 'form-control','id'=>'message','rows'=>'4', 'data-msg'=> __('frontend.enterYourMessage'),'data-rule'=>'required')) !!}
                        <div class="validation"></div>
                    </div>
