                    ...
                    <div class="col-sm-10">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="checkbox">
                                    <label class="ui-check">
                                        {!! Form::checkbox('permissions[]', '1' , in_array(1, $role->permissions) ? true : false , array('id' => 'vbMap')) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="checkbox">
                                    <label class="ui-check">
                                        {!! Form::checkbox('permissions[]', '2' , in_array(2, $role->permissions) ? true : false, array('id' => 'Status')) !!}
                                        <i class="dark-white"></i><label
                            ...
                            <div class="col-sm-4">
                                <div class="checkbox">
                                    <label class="ui-check">
                                        {!! Form::checkbox('permissions[]', '3' , in_array(3, $role->permissions) ? true : false, array('id' => 'Session')) !!}
                                        <i class="dark-white"></i><label
                            ...
                            <div class="col-sm-4">
                                <div class="checkbox">
                                    <label class="ui-check">
                                        {!! Form::checkbox('permissions[]', '4' , in_array(4, $role->permissions) ? true : false, array('id' => 'Consulting')) !!}
                                        <i class="dark-white"></i><label
                            ...
                            <div class="col-sm-4">
                                <div class="checkbox">
                                    <label class="ui-check">
                                        {!! Form::checkbox('permissions[]', '5' , in_array(5, $role->permissions) ? true : false, array('id' => 'Treatment')) !!}
                                        <i class="dark-white"></i><label
                            ...
                            <div class="col-sm-4">
                                <div class="checkbox">
                                    <label class="ui-check">
                                        {!! Form::checkbox('permissions[]', '6' , in_array(6, $role->permissions) ? true : false, array('id' => 'final')) !!}
                                        <i class="dark-white"></i><label
