...
return [
    ...
    */
    ...
    'max' => [
        ...
        'string' => 'يجب أن لا يتجاوز طول النّص في حقل :attribute :max حروفٍ/حرفًا',
    ...
    */
    'attributes' => [
        ...
        'title' => 'اسم الباقة',
        'advantages' => 'مميزات الباقة',
        'price' => 'سعر الباقة',
        'role' => 'الدور',
        'permissions' => 'الصلاحية',
        "target" => "الهدف الذي تم العمل عليه",
        "help_method" => "طريقة المساعدة",
        "behaviours" => "السلوكيات",
        "success_number" => "عدد مرات النجاح",
        "type" => "نوع الاستشارة",
        "problem" => "المشكلة",
        "solution" => "الحل",
        'companion' => "اسم مرافق الطفل",
        'status_type' => "نوع الجلسة",
